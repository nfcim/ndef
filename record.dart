...
class Record {
  ...
  static List<String> prefixMap=["","urn:nfc:wkt:","","","urn:nfc:ext:","unknown","unchanged"];
  static List<String> tnfMap=["empty","nfcWellKnown","media","absoluteURI","nfcExternel","unknown","unchanged"];
