...
class SignatureRecord extends Record{
  ...
  static List<String> hashTypeMap=[
    "",
    "",
    "SHA-256"
  ];

  static List<String> certificateFormatMap=[
    "X.509",
    "M2M"
  ];

  String signatureType,hashType,signatureURI,certificateFormat,certificateURI;
  List<List<int>> certificateStore;
  List<int> signature;

  SignatureRecord(String signatureType,String hashType,List<int> signature,
                  String signatureURI,String certificateFormat,List<List<int>>certificateStore,
  ...
  static dynamic decode_payload(List<int> PAYLOAD){
    ...
    return SignatureRecord(signatureType,hashType,signature,signatureURI,certificateFormat,certificateStore,certificateURI);
  }
}
