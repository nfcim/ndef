...
class ActionRecord extends Record{
  ...
  static dynamic decode_payload(List<int> PAYLOAD){
    ...
    assert(actionIndex<actionMap.length && actionIndex>=0,'Action code must be in [0,3)');
...
class SmartposterRecord extends Record{
  ...
  List<dynamic> titleRecords,uriRecords,actionRecords,iconRecords,sizeRecords,typeRecords;
